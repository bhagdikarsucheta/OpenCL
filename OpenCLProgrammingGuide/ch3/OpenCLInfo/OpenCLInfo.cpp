...
//Display information for a particuar platform.
//Assumes that all calls to clGetPlatformsInfo returns
...
void displayInfo(void)
{
	...
	//Nect allocate memory for installed platforms and query
	//to get this.
	platformIds = (cl_platform_id*)alloca(sizeof(cl_platform_id)*numPlatforms);
	//First query the number of platforms
	...
	//Iterate through the list of platforms displaying associted information
		...
		for (cl_uint i = 0; i < numPlatforms; i++)
		{
			...
			for (cl_uint j = 0; j < numDevices; j++)
			{
...
#ifdef CL_DEVICE_PREFERREF_VECTOR_WIDTH_HALF
				...
				InfoDevice<cl_uint>::display(
					...
					"CL_DEVICE_HOST_UNIFIED_MEMORY");
#endif // CL_DEVICE_HOST_UNIFIED_MEMORY
...
//main for OpenCL info
int main(int argc, char**argv)
{
	cl_context contect = 0;
	displayInfo();
	return 0;
}
